...
app = FastAPI(
    title='Greek-Site Southbound Plugin API',
    version='1.0.0',
    description='The Greek-Site Southbound Plugin API provides interfaces for managing application lifecycle in the Greek-Site infrastructure.\n\nFeatures:\n  - Application Management:\n     - Application Onboarding\n     - Create Application Instance\n     - Stop Application Instance\n  - Monitoring:\n     - Instance State WebSocket Events\n',
    servers=[
        {
            'url': '/api',
            'description': 'Greek-Site Southbound Plugin API endpoint',
        }
    ],
)
